  ...
  return (
    <div className="min-h-screen bg-white animate-fade-in">
      ...
      <div className="px-6 pt-6">
        <h2 className="text-xl font-bold text-gray-800 text-right leading-relaxed mb-4">
          قم بالترويج لحسابك والوصول إلى أكبر عدد ممكن من الأشخاص
        </h2>

        <h3 className="text-lg font-bold text-gray-800 text-right mb-3">فتح المحلات التجارية أو المعارض</h3>

        <p className="text-sm text-gray-600 text-right leading-relaxed mb-6">
        ...
        <div className="space-y-3 mb-8">
          {[
            ...
            <div key={i} className="flex items-start gap-2 justify-end text-sm text-gray-700">
              <span>{feature}</span>

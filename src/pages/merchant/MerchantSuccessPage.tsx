...
export default function MerchantSuccessPage() {
  ...
  return (
    <div className="min-h-screen bg-sovereign-card flex flex-col items-center justify-center px-6 animate-slide-up">
      <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-6 animate-float">
        <CheckCircle size={56} className="text-green-500" />
      </div>
      <h1 className="text-2xl font-bold text-text-primary mb-3 text-center">تم تقديم طلبك بنجاح!</h1>
      ...
      <p className="text-text-secondary text-center text-sm leading-relaxed mb-8">
      ...
      <div className="w-full space-y-3">
        ...
        <button onClick={() => navigate('/account')} className="w-full border-2 border-sovereign-border text-text-primary py-3 rounded-xl font-semibold text-sm">
          الذهاب لحسابي
        </button>
      </div>
    </div>
